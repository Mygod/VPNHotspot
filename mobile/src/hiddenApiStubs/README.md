...
* (since API 33) `Landroid/net/LinkAddress;-><init>(Ljava/net/InetAddress;I)V,sdk,test-api`
...
* (since API 33) `Landroid/net/NetworkAgent;-><init>(Landroid/content/Context;Landroid/os/Looper;Ljava/lang/String;Landroid/net/NetworkCapabilities;Landroid/net/LinkProperties;Landroid/net/NetworkScore;Landroid/net/NetworkAgentConfig;Landroid/net/NetworkProvider;)V,sdk,test-api`
* (since API 33) `Landroid/net/NetworkAgent;->register()Landroid/net/Network;,sdk,test-api`
* (since API 33) `Landroid/net/NetworkAgent;->markConnected()V,sdk,test-api`
* (since API 33) `Landroid/net/NetworkAgent;->unregister()V,sdk,test-api`
* (since API 33) `Landroid/net/NetworkAgent;->onNetworkCreated()V,sdk,test-api`
* (since API 33) `Landroid/net/NetworkAgent;->onNetworkDestroyed()V,sdk,test-api`
* (since API 33) `Landroid/net/NetworkAgent;->onNetworkUnwanted()V,sdk,test-api`
* (since API 33) `Landroid/net/NetworkAgent;->getNetwork()Landroid/net/Network;,sdk,test-api`
* (since API 33) `Landroid/net/NetworkAgentConfig$Builder;-><init>()V,sdk,test-api`
* (since API 33) `Landroid/net/NetworkAgentConfig$Builder;->setLegacyType(I)Landroid/net/NetworkAgentConfig$Builder;,sdk,test-api`
* (since API 33) `Landroid/net/NetworkAgentConfig$Builder;->setLegacyTypeName(Ljava/lang/String;)Landroid/net/NetworkAgentConfig$Builder;,sdk,test-api`
* (since API 33) `Landroid/net/NetworkAgentConfig$Builder;->build()Landroid/net/NetworkAgentConfig;,sdk,test-api`
* (since API 33) `Landroid/net/NetworkCapabilities;->NET_CAPABILITY_NOT_VCN_MANAGED:I,sdk,test-api`
* (since API 33) `Landroid/net/NetworkCapabilities$Builder;-><init>()V,sdk,test-api`
* (since API 33) `Landroid/net/NetworkCapabilities$Builder;->addTransportType(I)Landroid/net/NetworkCapabilities$Builder;,sdk,test-api`
* (since API 33) `Landroid/net/NetworkCapabilities$Builder;->addCapability(I)Landroid/net/NetworkCapabilities$Builder;,sdk,test-api`
* (since API 33) `Landroid/net/NetworkCapabilities$Builder;->removeCapability(I)Landroid/net/NetworkCapabilities$Builder;,sdk,test-api`
* (since API 33) `Landroid/net/NetworkCapabilities$Builder;->setNetworkSpecifier(Landroid/net/NetworkSpecifier;)Landroid/net/NetworkCapabilities$Builder;,sdk,test-api`
* (since API 33) `Landroid/net/NetworkCapabilities$Builder;->build()Landroid/net/NetworkCapabilities;,sdk,test-api`
* (since API 33) `Landroid/net/NetworkScore$Builder;-><init>()V,sdk,test-api`
* (since API 33) `Landroid/net/NetworkScore$Builder;->setLegacyInt(I)Landroid/net/NetworkScore$Builder;,sdk,test-api`
* (since API 33) `Landroid/net/NetworkScore$Builder;->build()Landroid/net/NetworkScore;,sdk,test-api`
* (since API 33) `Landroid/net/RouteInfo;-><init>(Landroid/net/IpPrefix;Ljava/net/InetAddress;Ljava/lang/String;I)V,sdk,test-api`
