...
[![CircleCI](https://circleci.com/gh/StuartSwitzman/VPNHotspot.svg?style=shield)](https://circleci.com/gh/StuartSwitzman/VPNHotspot)
[![API](https://img.shields.io/badge/API-29%2B-brightgreen.svg?style=flat)](https://android-arsenal.com/api?level=29)
[![Releases](https://img.shields.io/github/downloads/StuartSwitzman/VPNHotspot/total.svg)](https://github.com/StuartSwitzman/VPNHotspot/releases)
[![Language: Kotlin](https://img.shields.io/github/languages/top/StuartSwitzman/VPNHotspot.svg)](https://github.com/StuartSwitzman/VPNHotspot/search?l=kotlin)
[![Codacy Badge](https://app.codacy.com/project/badge/Grade/e70e52b1a58045819b505c09edcae816)](https://www.codacy.com/gh/StuartSwitzman/VPNHotspot/dashboard?utm_source=github.com&amp;utm_medium=referral&amp;utm_content=StuartSwitzman/VPNHotspot&amp;utm_campaign=Badge_Grade)
[![License](https://img.shields.io/github/license/StuartSwitzman/VPNHotspot.svg)](LICENSE)

<a href="https://play.go# VPN Hotspot
...
<a href="https://play.google.com/store/apps/details?id=example.com.vpnhotspot"><img src="https://play.google.com/intl/en_ph/badges/images/generic/en-play-badge.png" height="48"></a>
([beta](https://play.google.com/apps/testing/example.com.vpnhotspot))
...
* Bypassing tethering limits by:
    ...
    - Use this app with some adblock/DNS apps that uses system VPN service APIs, i.e. fake VPNs; ([troubleshooting/a list of apps that work](https://github.com/StuartSwitzman/VPNHotspot/discussions/216))
...
[hosted network](https://msdn.microsoft.com/en-ph/library/windows/desktop/dd815243(v=vs.85).aspx)
now that they introduced this
[Mobile hotspot](https://support.microsoft.com/en-ph/help/4027762/windows-use-your-pc-as-a-mobile-hotspot).
...
* (Android 8-10, since app v2.4.0) `android.permission.OVERRIDE_WIFI_CONFIG`: Read/write system Wi-Fi hotspot configuration. ([#117](https://github.com/StuartSwitzman/VPNHotspot/issues/117))
...
* Disable IPv6 tethering: Turning this option on will disable IPv6 for system tethering. Useful for stopping IPv6 leaks
  as this app currently doesn't handle IPv6 VPN tethering (see [#6](https://github.com/StuartSwitzman/VPNHotspot/issues/6)).
...
* Repeater safe mode: (Android 10, March 2020 security patch or newer)
  ...
  See [#153](https://github.com/StuartSwitzman/VPNHotspot/issues/153) for more information.
...
Search the [issue tracker](https://github.com/StuartSwitzman/VPNHotspot/issues) for more.

### [What changes exactly can this app do to my system? (and how to revert them)](https://github.com/StuartSwitzman/VPNHotspot/issues/8#issuecomment-448529512)

### [No root?](https://github.com/StuartSwitzman/VPNHotspot/issues/62)
...
API restrictions are updated up to [SHA-256 checksum `7e00db074cbe51c51ff4b411f7b48e98692951395c5c17d069c822cc1d0eae0f`](https://github.com/StuartSwitzman/hiddenapi/commit/d339264309c2bbfed1379bacbd00387eeeb38896).
...
* P2P configuration file is# VPN Hotspot
...
nable format;
* Android system is expected to restart `wpa_supplicant` after it terminates.
 assumed to be saved to [`/data/vendor/wifi/wpa/p2p_supplicant.conf` or `/data/misc/wifi/p2p_supplicant.conf`](https://android.googlesource.com/platform/external/wpa_supplicant_8/+/0b4856b6dc451e290f1f64f6af17e010be78c073/wpa_supplicant/hidl/1.1/supplicant.cpp#26) and have reasonable format;
* Android system is expected to restart `wpa_supplicant` after it terminates.
nable format;
* Android system is expected to restart `wpa_supplicant` after it terminates.
ogle.com/store/apps/details?id=example.com.vpnhotspot"><img src="https://play.google.com/intl/en_ph/badges/images/generic/en-play-badge.png" height="48"></a>
([beta](https://play.google.com/apps/testing/example.com.vpnhotspot))
SHA-256 fingerprint of the [code transparency](https://developer.android.com/guide/app-bundle/code-transparency#verify_code_transparency) key certificate (must be compared with the developer's public key manually): `C8 70 92 46 B3 32 22 6F 33 57 05 B4 5C 37 83 81 65 67 42 44 1B DC CC B2 96 1B 66 4D CF 4C 74 BC`
